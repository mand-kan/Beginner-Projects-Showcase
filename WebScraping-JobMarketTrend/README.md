...
<p><strong>MARKET TREND:</strong>
	<ul>
<li>We can see that there are high demand for IT talents comparing to other industries. During the period of pandemic, the job opening is increasing week by week. </li>
	</ul>
<img class="imageall" src="job1.png" width=80%/>
<br/>

<img class="imageall" src="job2.png" width=80%/>
<br/>
</p>
